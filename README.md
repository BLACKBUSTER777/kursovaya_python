...
•	Входные данные: текстовые строки (опционально).
•	Выходные данные: исходный код программы и результаты выполнения.
•	Программа должна быть устойчивой к ошибкам, поддерживать кодировку UTF-8 и иметь понятный интерфейс.
